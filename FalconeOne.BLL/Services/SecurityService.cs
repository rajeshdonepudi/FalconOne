...
namespace FalconeOne.BLL.Services
{
    public class SecurityService : BaseService, ISecurityService
    {
        ...
        {
            var result = await _unitOfWork.SecurityClaimsRepository.GetTenantSecurityClaimsForLookup(await _tenantService.GetTenantId());
        ...
        {
            var result = await _unitOfWork.SecurityRolesRepository.GetTenantSecurityRolesForLookup(await _tenantService.GetTenantId());
